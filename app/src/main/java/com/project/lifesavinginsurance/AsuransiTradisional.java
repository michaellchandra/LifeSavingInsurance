...
public class AsuransiTradisional extends AppCompatActivity {
    ...
    private TextView plan100_umur, plan100_uangp, plan100_masap, plan100_masaa;
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            main_button_hitung.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    int checkId = main_radiogroup_jeniskelamin.getCheckedRadioButtonId();
                    findRadioButton(checkId);
                    String b = plan100_umur.getText().toString();
                    int masa= Integer.parseInt(main_textinput_masa.getEditText().getText().toString().trim());
                    int umur = Integer.parseInt(main_textinput_umur.getEditText().getText().toString().trim());
                    ...
                    plan100_umur.setText(String.valueOf(umur));
                    plan100_uangp.setText(String.valueOf(a));
                    plan100_masap.setText(String.valueOf(masapremi));
                    long d = +tahunan;
